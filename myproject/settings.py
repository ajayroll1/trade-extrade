...
SECRET_KEY = 'django-insecure-@w&5kruuedzn3usur&s330k3xmwtx5qm((!lcyok2+k9oq*8v%'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'myapp/static'),  # Changed from 'myapp/templates' to 'myapp/static'
]
